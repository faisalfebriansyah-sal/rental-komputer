<template>
  <div class="min-h-screen bg-[#F6F4EB] flex items-center justify-center px-6">
    ...
    >
      ...
      <!-- Left Panel -->
      <div
        class="hidden md:flex flex-col justify-between bg-[#4682A9] p-10 text-white"
      >
        <div>
          <div class="flex items-center gap-3">
            <div
              class="flex h-11 w-11 items-center justify-center rounded-xl bg-white/15 text-xl"
            >
              🎮
            </div>
      ...
      <div class="p-8 sm:p-12 md:p-14">
        ...
        <div class="mx-auto max-w-md">
          ...
          <div class="mb-10 flex items-center gap-3 md:hidden">
            <div
              class="flex h-11 w-11 items-center justify-center rounded-xl bg-[#4682A9] text-xl"
            >
              🎮
            </div>
          ...
          <div class="mt-9 space-y-5">
            ...
            <div class="flex items-center justify-between text-sm">
              ...
              <label class="flex items-center gap-2 text-gray-500">
                <input
                  type="checkbox"
                  class="h-4 w-4 rounded border-gray-300 accent-[#4682A9]"
                />
              ...
              <button
                type="button"
                class="font-medium text-[#4682A9] hover:text-[#749BC2]"
              >
                Lupa password?
              </button>
            ...
            <button
              type="button"
              class="w-full rounded-xl bg-[#4682A9] py-3.5 text-sm font-semibold text-white shadow-lg shadow-[#4682A9]/20 transition hover:bg-[#749BC2] hover:shadow-xl"
            >
              Login
            </button>
          ...
          <div class="mt-8 text-center">
            <RouterLink
              to="/"
              class="text-sm text-gray-500 transition hover:text-[#4682A9]"
            >
